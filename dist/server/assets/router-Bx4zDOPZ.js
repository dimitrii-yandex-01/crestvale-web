...
const appCss = "/assets/styles-BkdWNzee.css";
  ...
  return /* @__PURE__ */ jsx(
    AppCtx.Provider,
    {
      value: {
        ...
        theme,
        setTheme,
        toggleTheme: () => setTheme((t2) => t2 === "light" ? "dark" : "light"),
        t
      },
      children
    }
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Аналитическое агентство: BI-дашборды, прогнозные ML-модели и аудит данных. Превращаем хаотичные данные в архитектуру решений." },
      ...
      { name: "theme-color", content: "#1b3a36" }
    ],
    links: [
      {
        rel: "icon",
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;700;800;900&family=JetBrains+Mono:wght@400;500;700&display=swap"
      }
    ]
  }),
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsx(AppProvider, { children: /* @__PURE__ */ jsx(Outlet, {}) }) });
}
const $$splitComponentImporter = () => import("./index-D2AfIFTO.js");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Аналитическое бюро: BI-дашборды, прогнозные ML-модели, аудит данных. Превращаем хаос данных в архитектуру решений."
    }, {
      property: "og:title",
      content: "Crestvale Analytics — Аналитика данных"
    }, {
      property: "og:description",
      content: "BI-дашборды, прогнозные модели и аудит данных."
    }]
  }),
